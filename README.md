...
- **Security**: 7-day supply-chain policy (min-release-age), no lifecycle scripts, all chain-derived strings sanitized, slippage protection.
...
This is a testnet demo. For production use, conduct an external audit of the contracts and review the frontend sanitization + error-handling.
